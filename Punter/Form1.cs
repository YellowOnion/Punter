...
namespace Punter
{
    public partial class Form1 : Form
    {
        ...
        private Action Maximize(Punter punter)
        {
            return delegate ()
            {
                nuAmount.Maximum = (decimal)punter.wallet;
                selected = punter;
            };
        }
        ...
        private void DrawPunter(Punter punter, Label wallet, Label amount, Label dog)
        {
            amount.Text = punter.betAmount.ToString();
            wallet.Text = punter.wallet.ToString();
            try
            {
                dog.Text = punter.betHound.name;
            }
